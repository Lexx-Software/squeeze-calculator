export default {
    ...
    footer: {
        ...
        text: 'Этот сайт использует Google Analytics для сбора анонимной статистики о посетителях с целью улучшения пользовательского опыта. <br>Продолжая использование сайта, вы соглашаетесь с использованием файлов cookie.',
    },
    validation: {
